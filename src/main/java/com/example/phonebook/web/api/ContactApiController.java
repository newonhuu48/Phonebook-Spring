...
public class ContactApiController {
    ...
    public Page<ContactDTO> getContacts(
        ...
        //return contactService.getAllContacts(firstName, lastName, phoneNumber, email, page, size, sortField, sortDir);

        return contactService.getContactsByUser(firstName, lastName, phoneNumber, email, page, size, sortField, sortDir);
    }
